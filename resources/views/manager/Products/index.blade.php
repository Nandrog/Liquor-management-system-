                        ...
                        <table class="min-w-full divide-y divide-gray-200 table table-hover align-middle">
                            <thead class="bg-gray-50 table-lights">
                                <tr>
                                    ...
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Current Unit Price</th>
                                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Original Subtotal</th>
                                </tr>
                            </thead>
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr>
                                    ...
                                    {{-- ======================= THE FINAL FIX ======================= --}}
                                    {{-- Changed 'price' to 'unit_price' to match the actual database column name --}}
                                    <td class="px-6 py-4 whitespace-nowrap">UGX {{ number_format($item->product->unit_price ?? 0, 2) }}</td>

                                    {{-- The original subtotal, using the price at the time of order --}}
