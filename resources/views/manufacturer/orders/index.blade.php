<x-app-layout>
    ...
    <a href="{{ route('manufacturer.orders.delivering') }}"
       class="text-sm font-medium {{ request()->routeIs('manufacturer.orders.delivering') ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-gray-700' }}">
       In Delivery
    </a>
</div>
</x-app-layout>
